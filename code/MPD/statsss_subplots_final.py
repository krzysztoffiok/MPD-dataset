...
##################### HERE DEFINE VARIANT #####################
analyzed_set = natat_f_lm
# analyzed_set = trec_lm
# analyzed_set = trec_hidden_size
###############################################################

if analyzed_set.natat:
    analyzed_set.file_list = [join("./results/paper_xlsx", x) for x in analyzed_set.file_list]
