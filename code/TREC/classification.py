...
python3 classification.py --k_folds=10 --subset=test --test_run=t1
...
for fold in range(k_folds):
    ...
    f1sub_list.append(float(cr.loc[gsc[0]]["f1-score"]))
    f1perf_list.append(float(cr.loc[gsc[1]]["f1-score"]))
    f1rec_list.append(float(cr.loc[gsc[2]]["f1-score"]))
    f1tec_list.append(float(cr.loc[gsc[4]]["f1-score"]))
    f1time_list.append(float(cr.loc[gsc[3]]["f1-score"]))
...
aggregated_fold_scores[f"F1 {gsc[0]}"] = f1sub_list
aggregated_fold_scores[f"F1 {gsc[1]}"] = f1perf_list
aggregated_fold_scores[f"F1 {gsc[2]}"] = f1rec_list
aggregated_fold_scores[f"F1 {gsc[4]}"] = f1tec_list
aggregated_fold_scores[f"F1 {gsc[3]}"] = f1time_list
